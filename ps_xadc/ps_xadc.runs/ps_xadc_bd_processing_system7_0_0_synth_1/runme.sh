...
HD_PWD='E:/ZYNQ_7z020/ps_xadc/ps_xadc.runs/ps_xadc_bd_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_xadc_bd_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_xadc_bd_processing_system7_0_0.tcl
