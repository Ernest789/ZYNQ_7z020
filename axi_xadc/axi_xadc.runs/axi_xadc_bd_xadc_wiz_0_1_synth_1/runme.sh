...
HD_PWD='E:/ZYNQ_7z020/axi_xadc/axi_xadc.runs/axi_xadc_bd_xadc_wiz_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_xadc_bd_xadc_wiz_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_xadc_bd_xadc_wiz_0_1.tcl
