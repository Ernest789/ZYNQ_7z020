...
HD_PWD='E:/ZYNQ_7z020/axi_xadc/axi_xadc.runs/axi_xadc_bd_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_xadc_bd_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_xadc_bd_processing_system7_0_0.tcl
