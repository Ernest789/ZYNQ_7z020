...
HD_PWD='E:/ZYNQ_7z020/axi_xadc/axi_xadc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_xadc_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_xadc_bd_wrapper.tcl -notrace
