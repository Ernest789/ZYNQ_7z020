...
HD_PWD='E:/ZYNQ_7z020/axi_gpio/axi_gpio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_axi_gpio_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_axi_gpio_wrapper.tcl
