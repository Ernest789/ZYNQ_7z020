...
HD_PWD='E:/ZYNQ_7z020/axi_gpio/axi_gpio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_axi_gpio_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bd_axi_gpio_wrapper.tcl -notrace
