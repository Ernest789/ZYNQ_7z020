...
HD_PWD='E:/ZYNQ_7z020/axi_gpio/axi_gpio.runs/bd_axi_gpio_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_axi_gpio_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_axi_gpio_rst_ps7_0_50M_0.tcl
