...
HD_PWD='E:/ZYNQ_7z020/dma/dma.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_dma_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bd_dma_wrapper.tcl -notrace
