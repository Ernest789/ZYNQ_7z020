...
HD_PWD='E:/ZYNQ_7z020/dma/dma.runs/bd_dma_auto_us_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_dma_auto_us_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_dma_auto_us_1.tcl
