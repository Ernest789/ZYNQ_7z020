...
HD_PWD='E:/ZYNQ_7z020/dma/dma.runs/bd_dma_axis_data_fifo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_dma_axis_data_fifo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_dma_axis_data_fifo_0_0.tcl
